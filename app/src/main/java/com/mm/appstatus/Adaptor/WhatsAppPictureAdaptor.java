...
import com.mm.appstatus.Main2Activity;
import com.mm.appstatus.Main4Activity;
import com.mm.appstatus.Main5Activity;
...
public class WhatsAppPictureAdaptor extends RecyclerView.Adapter<WhatsAppPictureAdaptor.MyViewHolder> implements Subject {
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        public ImageButton img_btn_download, img_btn_share,upll;
        ...
        public MyViewHolder(View v) {
         ...
         //   upll = v.findViewById(R.id.upl);
           /* upll.setOnClickListener(new View.OnClickListener() {
            ...
            pd = new ProgressDialog(acontext);
